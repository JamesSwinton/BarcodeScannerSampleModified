...
public class MainActivity extends Activity implements EMDKListener, DataListener, StatusListener, ScannerConnectionListener, OnCheckedChangeListener {
    ...
    private Button disableScannerButton = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        disableScannerButton = (Button) findViewById(R.id.disableScan);
        ...
        disableScannerButton.setOnClickListener(new OnClickListener() {
            @Override
...
//    }
    ...
    private void deInitScanner() {
        ...
        try {
            ...
            Log.e("MainActivity", "ScannerException: " + e.getMessage());
        }
    }
